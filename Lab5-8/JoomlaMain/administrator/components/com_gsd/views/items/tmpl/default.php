    ...
    <div class="nr-row">
        ...
        <div class="nr-main-container">
            <div class="nr-main-header">
                <h2><?php echo Text::_('GSD_ITEMS'); ?></h2>
                <p><?php echo Text::_('GSD_ITEMS_VIEW_DESC'); ?></p>
            </div>
            <div class="nr-main-content">
                <form action="<?php echo Route::_('index.php?option=com_gsd&view=items'); ?>" class="nr-app-form" method="post" name="adminForm" id="adminForm">
                <div class="nr-box">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                if ($canChange)
                                                {
                                                    ...
                                                    HTMLHelper::_('actionsdropdown.' . 'duplicate', 'cb' . $i, 'items');
