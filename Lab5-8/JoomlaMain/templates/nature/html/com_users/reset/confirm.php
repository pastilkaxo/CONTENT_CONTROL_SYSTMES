...
<section class="u-clearfix">
    <div class="u-clearfix u-sheet">
        <div class="reset-confirm<?php echo $this->pageclass_sfx; ?>">
            ...
            <?php endif; ?>
            <div class="u-form">
                <form action="<?php echo Route::_('index.php?option=com_users&task=reset.confirm'); ?>" method="post" class="<?php echo $formClass ? $formClass : 'form-validate form-horizontal well'; ?>">
                    <?php
