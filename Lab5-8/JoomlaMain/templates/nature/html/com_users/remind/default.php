...
<section class="u-clearfix">
    <div class="u-clearfix u-sheet">
        <div class="remind<?php echo $this->pageclass_sfx; ?>">
            ...
            <?php endif; ?>
            <div class="u-form">
                <form id="user-registration" action="<?php echo Route::_('index.php?option=com_users&task=remind.remind'); ?>" method="post" class="<?php echo $formClass ? $formClass : 'form-validate form-horizontal well'; ?>">
                    <?php
