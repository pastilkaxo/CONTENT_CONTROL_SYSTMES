...
?>
		...
		<section class="footer-bottom">
			<div class="container">
                ...
                printf( esc_html__( 'Copyright &copy; %1$s %2$s. %4$s %3$s WordPress theme design & developer by aThemeArt ', 'store-commerce' ), esc_attr( date( 'Y' ) ), esc_html( get_bloginfo( 'name' ) ), '<a href="https://wordpress.org/themes/store-commerce/" target="_blank">Store Commerce</a>','<br/>' );
                ?></p>
