...
if( !function_exists('store_commerce_header_container_middle') ):
    ...
    <div class="row justify-content-md-center store-commerce-header">
        <div class="col-md-3 align-self-end">
        	<?php do_action('store_commerce_product_category');?>
        </div>
        <div class="col-md-6">
...
add_action( 'store_commerce_product_category', 'store_commerce_woocommerce_product_category' );
if ( ! function_exists( 'store_commerce_woocommerce_product_category' ) ) {
     ...
     * @return void
     */
    function store_commerce_woocommerce_product_category() {
         ...
         if ( ! class_exists( 'WooCommerce' ) ) { return;}
                ...
                echo '<div id="mega-menu" class="">
                          <div class="btn-mega"><span></span>'.esc_html( esc_html__('ALL CATEGORIES ','store-commerce') ).'</div>
                          <ul class="menu">';
